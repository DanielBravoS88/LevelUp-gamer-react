  ...
  return (<footer className="lp-footer">
    <div className="lp-footer__container">
      <div className="lp-footer__col lp-footer__brand">
        <h3 className="lp-footer__title">LevelUp <span>Gamer</span></h3>
        <div className="lp-footer__social">
          <a href="#" className="social-icon instagram" aria-label="Instagram LevelUp Gamer">
          ...
          <a href="#" className="social-icon facebook" aria-label="Facebook LevelUp Gamer">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="lp-footer__col"><h4 className="lp-footer__heading">Corporativo</h4>
        <ul className="lp-footer__links">
          ...
          <li><a href="#">¿Quieres trabajar en LevelUp?</a></li>
